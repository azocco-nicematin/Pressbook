describe('vsiaulMap_setOption', function() {
    ...
    testCase.createChart()('eraseAllVisualProps_notRelative', function () {
        ...
        // Do not compare controllers.inRange.symbolSize, which will be amplified to controllers size.
        // expect(option.visualMap[0].controllers.inRange.symbolSize).toEqual([?, ?]);
    });
